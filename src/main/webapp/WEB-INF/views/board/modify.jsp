			...
			<div class="inner">
				...
				<div style="width:900px; border: lightgray 1px solid">
					<form id="WriteFrom" method="POST">
						<input type="hidden" id="seqno" value="${view.seqno }">
						<table>
							...
							<tr style="height: 40px;">
								...
								<td> <input type="text" class="input_field" name="title" id="title"
										placeholder="제목을 입력하세요." value="${view.title}"> </td>
							</tr>
							<tr style="height: 40px;">
								<td colspan="2"> 내용 </td>
								<td> </td>
							...
							<tr>
								<td colspan="2" align="center"><textarea class="input_content" id="content"
										...
										placeholder="여기에 내용을 입력하세요.">${view.content}</textarea>
								</td>
							</tr>
							...
							<tr style="height: 45px;">
								<td colspan="2">
									...
									<c:if test="${fileListView != null }">
										<span style="text-align:left; font-size:13pt; font-weight: 400; color: #828282;"> 삭제를 원하는 파일은 '삭제'에 표시해주세요.</span>
									</c:if>
								</td>
							</tr>
							<tr>
								<td colspan="2">
									<c:if test="${fileListView != null }">
										<div id="fileList" style="font-weight:500; width:750px; min-height:100px;" align="center">
											<p style="text-align:left; font-size:16px;">
												<c:forEach items="${fileListView}" var="file" >
													<input type="checkbox" id="${file.fileseqno}" name="deleteFileList" value="${file.fileseqno}"
														style="position:relative; top: -5px;">
													<label for="${file.fileseqno}">삭제</label>
							...
							<tr>
								<td colspan="2">
									<div align="center" style="margin-top: 40px;">	<!-- 처리 버튼 -->
										<input type="button" class="button primary small" style="width:20%" id="btn_modify" value="수정" >
